...
def get_simulator(space, run_config):
    ...
    from hpo.trainers.emul.trainer import TrainEmulator
    from hpo.trainers.emul.grad_etr import GradientETRTrainer
    from hpo.trainers.emul.median_etr import VizMedianETRTrainer 
    from hpo.trainers.emul.threshold_etr import ThresholdingETRTrainer 
    from hpo.trainers.emul.threshold_etr import MultiThresholdingETRTrainer     
    from hpo.trainers.emul.knock_etr import KnockETRTrainer
    from hpo.trainers.emul.interval_etr import IntervalETRTrainer
    from hpo.trainers.emul.hybrid_etr import HybridETRTrainer
    from hpo.trainers.emul.kickstart_etr import KickStarterETRTrainer
    from hpo.trainers.emul.curve_predict_etr import CurvePredictETRTrainer
...
def get_remote_trainer(rtc, space, run_config):
    from hpo.trainers.remote.trainer import RemoteTrainer    
    from hpo.trainers.remote.grad_etr import GradientETRTrainer
    from hpo.trainers.remote.threshold_etr import MultiThresholdingETRTrainer
